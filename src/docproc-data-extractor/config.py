"""
Configuration management for the docproc-data-extractor service.

This module provides centralized configuration loading and validation
for the document data extraction service using OpenAI API,
...
class AzureOpenAIConfig(BaseModel):
    ...
    model: str = Field(
        default="gpt-4o-mini",
        description="Azure OpenAI model to use for data extraction",
        example="gpt-4o-mini"
    )
